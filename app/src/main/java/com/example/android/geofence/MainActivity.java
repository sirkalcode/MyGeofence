...
public class MainActivity extends FragmentActivity {
    ...
    protected void onResume() {
         ...
         */
        mUIGeofence1 = mPrefs.getGeofence("11");
        mUIGeofence2 = mPrefs.getGeofence("22");
        /*
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_clear_geofence_history:
                mPrefs.clearGeofence("11");
                mPrefs.clearGeofence("22");
                return true;
    ...
    protected void onPause() {
        super.onPause();
        mPrefs.setGeofence("11", mUIGeofence1);
        mPrefs.setGeofence("22", mUIGeofence2);
    }
    ...
    private boolean servicesConnected() {
        ...
        Log.d("GEOFENCE", "Inside services connected");

        // Check that Google Play services is available
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(this);

        Log.d("GEOFENCE", "POST isGoolePlayServicesAvailable check");

        // If Google Play services is available
        if (ConnectionResult.SUCCESS == resultCode) {

            Log.d("GEOFENCE", "GOOGLE PLAY SERVICES Available");
        ...
        // Google Play services was not available for some reason
            ...
            Log.d("GEOFENCE", "GOOGLE PLAY SERVICES NOT Available");
    ...
    public void onRegisterClicked(View view) {
        ...
        Log.d("GEOFENCES: OnButtonClicked"," 1.Clicked");
        ...
        Log.d("GEOFENCES: OnButtonClicked"," 2.Pre Servicesconnected check");
        if (!servicesConnected()) {
            Log.d("GEOFENCES: OnButtonClicked"," 2.Services not connected");
            return;
        }
         ...
         */
        if (!checkInputFields()) {
            Log.d("GEOFENCES: OnButtonClicked"," 3.Inputs not provided");
            return;
        }
        ...
        Log.d("GEOFENCES: Add Geo offence 1"," Geofences 1 ADDED");
        ...
        Log.d("GEOFENCES: Add Geo offence 2"," Geofences 2 ADDED");
         ...
         * flat object
         */
        Log.d("GEOFENCES: Adding Geo offences"," Adding Geofences to list");
        ...
        try {
            ...
            Log.d("GEOFENCES: GeoFenceRequester", " Adding Geofences");
            mGeofenceRequester.addGeofences(mCurrentGeofences);
            Log.d("GEOFENCES: GeoFenceRequester", " Added Geofences");
        } catch (UnsupportedOperationException e)
        {
            // Notify user that previous request hasn't finished.
