...
public class ReceiveTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("GEOFENCES ReceiveTransitionsIntentService","PRE BroadcastIntent");
        ...
        // If there's no error, get the transition type and create a notification
            ...
            Log.d("GEOFENCES ReceiveTransitionsIntentService","LocationClient getGeofenceTransition");
            ...
            {
                Log.d("GEOFENCES ReceiveTransitionsIntentService","transition enter or exit");
