                                            ...
                                            OnConnectionFailedListener
{
    ...
    public void addGeofences(List<Geofence> geofences) throws UnsupportedOperationException {
         ...
         */
        Log.d("GEOFENCES: GeoFenceRequester", " Inside Geofence Requester");
        mCurrentGeofences = (ArrayList<Geofence>) geofences;

        // If a request is not already in progress
        if (!mInProgress) {

            Log.d("GEOFENCES: GeoFenceRequester", "Pre In Progress, requesting connection");
            ...
            Log.d("GEOFENCES: GeoFenceRequester", "POST In Progress, requesting connection");
    ...
    private void requestConnection() {
        ...
        Log.d("GEOFENCES: GeoFenceRequester", "Pre getlocation client, requesting connection");
        getLocationClient().connect();
        Log.d("GEOFENCES: GeoFenceRequester", "POST getlocation client, requesting connected");
    }
    ...
    private GooglePlayServicesClient getLocationClient() {
        if (mLocationClient == null) {
            ...
            Log.d("GEOFENCES: getLocationClient()", "LocationActivity");
    ...
    private void continueAddGeofences() {
        ...
        Log.d("GEOFENCE requester","Inside continueAddGeofences....");
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        Log.d("Geofence Requester: onAddGeofencesResult" , statusCode + "");
        ...
        // If adding the geofences failed
            ...
            // Log an error
            Log.e(GeofenceUtils.APPTAG + "XXXX" , msg);
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d("GEOFENCE requester", "In GeofenceRequester class. Checking onConnected");
    ...
    private PendingIntent createRequestPendingIntent() {
        ...
        Log.d("GEOFENCES creatingIntents","PRE createRequestPendingIntent");
        ...
        // If no PendingIntent exists
            ...
            Log.d("GEOFENCES creatingIntents","PRE Creating Intent");
            // Create an Intent pointing to the IntentService
            Intent intent = new Intent(mActivity, ReceiveTransitionsIntentService.class);

            Log.d("GEOFENCES creatingIntents","POST Creating Intent");
